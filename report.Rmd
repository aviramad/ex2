...
```
הערה: קיימים מספר שדות בעלי פרמטרים ריקים, כמו 
- Age
- Embarked

אך איננו משתמשים בשדות אלו בהרצה זו ועל כן אין צורך לטפל בהם כעת
...
### קריאת נתונים ועיבוד מקדים ###
קריאת הנתונים בשלב זה זהה לקריאה בהרצה הראשונה שביצענו
...
### קריאת נתונים ועיבוד מקדים ###
קריאת הנתונים ועיבודם זהה להרצה השניה שביצענו
