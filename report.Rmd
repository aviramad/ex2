...
qplot(female_train$Age, main="Avg Age - females", bins = 50, xlab = "Age", ylab = "number of people")
...
qplot(female_test$Age, main="Avg Age - females", bins = 50, xlab = "Age", ylab = "number of people")
...
qplot(male_train$Age, main="Avg Age - males", bins = 50, xlab = "Age", ylab = "number of people")
...
qplot(male_test$Age, main="Avg Age - males", bins = 50, xlab = "Age", ylab = "number of people")
